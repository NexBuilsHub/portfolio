    ...
    <div class="container mx-auto px-6">
      <div class="grid md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <div class="space-y-3">
            <a href="mailto:youssefbouyez2@gmail.com" class="flex items-center space-x-3 text-gray-400 hover:text-pink-500 transition-colors">
              <EnvelopeIcon class="w-5 h-5" />
              <span>youssefbouyez2@gmail.com</span>
            </a>
        ...
        <div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              class="w-10 h-10 bg-gray-800 hover:bg-green-500 rounded-full flex items-center justify-center transition-colors"
              title="WhatsApp"
            >
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-800">
        <div class="mb-4 md:mb-0">
          <p class="text-gray-400">©2026 Youssef Bouayez. All Rights Reserved.</p>
        </div>
        
        <button 
          @click="scrollToTop"
          class="w-10 h-10 bg-pink-500 hover:bg-pink-600 rounded-full flex items-center justify-center transition-colors duration-300"
        >
